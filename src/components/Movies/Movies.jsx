...
function Movies({ setTextSearchError, moviesList, isLoading, addMovie, width, location, deleteMovie, textSearchError, setIsLoading, isValid, setIsValid, moviesSavedList }) {
                     ...
                     <div className="movies__content">
                        ...
                        <ul className='list movies__list'>
                           {currentMoviesList.map((element) =>
                              <MoviesCard addMovie={addMovie} movie={element} isLoading={isLoading} deleteMovie={deleteMovie} key={element.id || element._id} location={location} moviesSavedList={moviesSavedList} />)}
                        </ul >
